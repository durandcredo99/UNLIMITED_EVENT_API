        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CategoryBlogId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AppUserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NoPriority = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PromoteEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PromoteEvents_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PromoteEvents_Promotes_PromoteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Commercials_SubCategoryId",
                table: "Commercials",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PromoteEvents_EventId",
                table: "PromoteEvents",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_PromoteEvents_PromoteId",
                table: "PromoteEvents",
                column: "PromoteId");
        }
